...
database.ref("users/" + my_uid + "/").once("value", function(snapshot) {
    console.log(snapshot.val())
    my_info = snapshot.val()
    console.log(my_info.photos)
        
    // Initial start of the timer
    if(my_info.photos != undefined) {
        restartTimer();
        console.log("hello")
    }
})
